...
const MODULES = [
  { key: 'module_social', label: 'Espace Social', Icon: MessageCircle, desc: 'Messagerie anonyme, modes de visibilité', color: '#3B82F6', bg: '#EFF6FF' },
  { key: 'module_games', label: 'Mini-Jeux', Icon: Gamepad2, desc: 'Quiz, trivia, jeux couple et famille', color: '#8B5CF6', bg: '#F5F3FF' },
  { key: 'module_birthday', label: 'Anniversaire', Icon: CakeSlice, desc: 'Détection, cadeau surprise, chanson', color: '#EC4899', bg: '#FDF2F8' },
  { key: 'module_loyalty', label: 'Fidélité', Icon: Star, desc: 'Points, historique, récompenses', color: '#F59E0B', bg: '#FFFBEB' },
  { key: 'module_delivery', label: 'Livraison', Icon: Truck, desc: 'Commande à distance, vue ambiance', color: '#10B981', bg: '#ECFDF5' },
] satisfies Array<{ key: ModuleKey; label: string; Icon: LucideIcon; desc: string; color: string; bg: string }>

const GAMES = [
  { key: 'quiz', label: 'Quiz Culture G.', Icon: Brain, desc: 'Questions multijoueur', players: '1-4', color: '#8B5CF6' },
  { key: 'trivia', label: 'Trivia Cuisine', Icon: CookingPot, desc: 'Gastronomie locale', players: '1-6', color: '#F59E0B' },
  { key: 'couple_quiz', label: 'Quiz Couple', Icon: Heart, desc: 'Vous connaissez-vous ?', players: '2', color: '#EC4899' },
  { key: 'mots_croises', label: 'Mots Croisés', Icon: Type, desc: 'Vocabulaire solo/duo', players: '1-2', color: '#10B981' },
]
        ...
        {tab === 'jeux' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="sm:col-span-2 bg-purple-50 border border-purple-100 rounded-3xl p-4">
              <p className="text-xs font-bold text-purple-700 mb-1 flex items-center gap-1.5">
                <Rocket size={13} />
